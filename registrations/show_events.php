    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <select name="eventId" id="eventId">
                ...
                // Retrieve enabled events
                $sql = "SELECT id, event_name FROM events WHERE enabled = 1 ORDER BY event_date DESC";
            ...
            if (isset($_POST["eventId"]) && ctype_digit($_POST["eventId"])) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<p><strong>Type:</strong> " . ucfirst(str_replace("_", " ", htmlspecialchars($row["event_type"]))) . "</p>";
